        ...
        children: [
            {
                path: 'lessons', children: [
                    ...
                    {
                        path: ':lessonId',
                        loadChildren: () => import('./lessons/lesson/lesson.module').then(m => m.LessonPageModule)
                    }
                ]
            },
            {
                path: 'notes', children: [
                    ...
                    {
                        path: 'new',
                        loadChildren: () => import('./notes/new-note/new-note.module').then(m => m.NewNotePageModule)
                    },
                    {
                        path: 'edit/:noteId',
